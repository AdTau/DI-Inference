  ...
  %delays at different delays betweeen simultaneously discrete signals. 
  %The code is structured to repeat this computation over all possible 
  %slicing time windows ('intervals) of a given lengeth within a fixed trial,
  %and over all available trials.
